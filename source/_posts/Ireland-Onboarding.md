---
title: Essential Life Guide for Newcomers to Ireland
...
1. Access cellular network, meaning mobile data. Although domestic Chinese SIM cards can access the internet through roaming, first, it is relatively expensive at 25 CNY per day; second, it cannot access the outside internet, so commonly used services here such as Google Maps and Google Search cannot be used without a VPN.
2. Many places for handling documents or registering accounts cannot use foreign numbers, such as bank cards, WhatsApp for local communication (similar to WeChat), and residence cards.
3. Calling local people. When newly arrived, there are many local people to contact, such as the pickup driver, temporary-accommodation landlord, school or company contacts. Having a local phone number is much more convenient and affordable.
...
- [Vodafone](https://n.vodafone.ie/shop/pay-as-you-go-plans/vodafone-x.html). Ireland's largest carrier, with relatively reliable signal. 20 euros.
- [Tesco Mobile](https://www.tescomobile.ie/sim-only-plans.aspx). Its main business is supermarkets, with many stores. You can buy it in supermarkets or online. 20 euros.
- [GoMo](https://shop.gomo.ie/). Online-only brand, cheap. 15 euros.
- [lycamobile](https://www.lycamobile.ie/). Online-only brand, the cheapest. 10 euros for the first 12 months.
...
- Internet setup is complicated. If the configuration is wrong, it will charge randomly. I was trapped for nearly 5 euros. The specific configuration method is: 1. Follow the instructions in the order email. First dial `*116*PIN#`; your PIN can be found in the email. 2. Then follow the second step of [this official instruction](https://www.lycamobile.ie/en/help/mobile-web-settings/) to enable roaming and configure APN (Name: lyca internet, APN: data.lycamobile.ie, Username: lmie, Password: plus). Only after that can you access the internet normally.
