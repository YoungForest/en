...
This year I still stayed in the ["Cruel Coding group"](http://board.cruelcoding.com/), participated in almost every weekly contest (missing only two), and although I cannot say I solved problems every day, I did solve them on nearly half the days. Problem solving is no longer a burden for me; it has become recreation, truly a hobby and habit. My rating is now 2450+ on both the [US site](https://leetcode.com/YoungForest/) and the [China site](https://leetcode-cn.com/YoungForest/), which counts as a small achievement.
